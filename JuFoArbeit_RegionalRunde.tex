...
\begin{figure}[htbp]
    ...
    \caption{Externer Validierungstest: Projektion von Ravels \emph{Streichquartett in F-Dur} (Diamantmarker) in die PCA-Wolken. \emph{Klickbar für interaktive Ansicht.}}\label{fig:ravel}
\end{figure}
...
Die zweite Forschungsfrage -- \enquote{Bestätigt die quantitative Landkarte Chopins Rolle als Brückenfigur?} -- kann empirisch beantwortet werden: \newline\textbf{Ja, mit quantifiziertem Mechanismus.}
...
\begin{enumerate}
    ...
    \item \textbf{Historischer Kontext:} Die Daten stützen die These, dass Debussys Innovationen ohne Chopins Vorarbeit weniger plausibel gewesen wären. Chopin \enquote{öffnete} den stilistischen Raum: Er zeigte, dass Chromatik und Dissonanz mit klassischen Formen kompatibel sind. Debussy radikalisierte dann diese Tendenzen und löste die verbliebenen klassischen Strukturen auf.
\end{enumerate}
...
\subsection{Fazit}
Die zentrale Forschungsfrage -- \enquote{Kann ein kuratierter Satz interpretierbarer Merkmale eine empirische Landkarte erstellen, die stilistische Trennung und Evolution quantifiziert?} -- wurde umfassend beantwortet.
...
\begin{enumerate}
    ...
    \item \textbf{Debussy-Isolation:} 16 signifikante Unterschiede zu Mozart belegen Debussys revolutionären Sonderstatus. Die PCA positioniert ihn als isolierte \enquote{impressionistische Insel}.
