...
\begin{figure}[htbp]
    ...
    \caption{Harmonisches Merkmal: Dissonanzanteile. Debussy und Chopin zeigen signifikant höhere Werte als Bach und Mozart, was die zunehmende Komplexität der harmonischen Sprache im 19.\ Jahrhundert widerspiegelt. Box: Interquartilsabstand (IQR), Linie: Median.}\label{fig:dissonance}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/melodic/boxplot_pitch_range_semitones.png}
    \caption{Melodisches Merkmal: Ambitus (Tonumfang) in Halbtonschritten. Romantische und impressionistische Werke nutzen deutlich größere Register, was erweiterte Ausdrucksmöglichkeiten des modernen Flügels widerspiegelt. Box: Interquartilsabstand (IQR), Linie: Median.}\label{fig:ambitus}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/rhythmic/boxplot_rhythmic_pattern_entropy.png}
    \caption{Rhythmisches Merkmal: Entropie der rhythmischen Muster. Debussy zeigt die höchste rhythmische Vielfalt, während Bach trotz kontrapunktischer Komplexität repetitive rhythmische Muster verwendet. Box: Interquartilsabstand (IQR), Linie: Median.}\label{fig:rhyentropy}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Externer Validierungstest: Joe Hisaishis \emph{One Summer's Day} (2001) projiziert in die PCA-Wolken. Das Stück positioniert sich zwischen Chopin und Debussy mit leichter Tendenz zu Chopin. Diese Platzierung illustriert die Generalisierungsfähigkeit der Merkmalsextraktion: Hisaishi nutzt bekanntermaßen spätromantische Harmonik (Chopin-Nähe) kombiniert mit impressionistischen Klangfarben (Debussy-Nähe).}\label{fig:hisaishi}
\end{figure}

\noindent Interaktive Version der Abbildung (Hisaishi): \href{https://victor-gurbani.github.io/JuFo2026/figures/highlights/one_summers_day_pca_cloud.html}{\faLink\ one\_summers\_day\_pca\_cloud.html}.
...
\begin{figure}[htbp]
    ...
    \IfFileExists{ravelhighlight_cropped.png}{%
        \href{https://victor-gurbani.github.io/JuFo2026/figures/highlights/ravel_string_quartet_pca_cloud.html}{%
...
Interaktive Projektion (Ravel): \href{https://victor-gurbani.github.io/JuFo2026/figures/highlights/ravel_string_quartet_pca_cloud.html}{\faLink\ ravel\_string\_quartet\_pca\_cloud.html}.
...
\textbf{PC3 (9,8\% Varianz) -- Registrale Textur:} Diese Achse misst vor allem den Tonumfang (\texttt{pitch\_range\_semitones}) und intervallische Vielfalt. Hohe Werte charakterisieren Werke, die den erweiterten Ambitus des modernen Flügels ausnutzen. Dieser Anstieg reflektiert nicht nur stilistische Ambitionen, sondern auch die technologische Evolution des Instrumentenbaus (vom Cembalo zum modernen 88-Tasten-Flügel).
...
Die zweite Forschungsfrage -- ``Bestätigt die quantitative Landkarte Chopins Rolle als Brückenfigur?'' -- kann empirisch beantwortet werden: \newline\textbf{Ja, mit quantifiziertem Mechanismus.}
...
Die statistischen Aggregate verbergen instruktive Extremfälle, die die Generalisierungsfähigkeit der Merkmalsextraktion illustrieren:
...
\textbf{Methodischer Erfolg:} Die entwickelte Pipeline kombiniert moderne Werkzeuge (PDMX-Archiv, \texttt{music21}, Python-Statistik) mit musikologischer Interpretierbarkeit. Im Gegensatz zu früheren Ansätzen (\cite{LinJeng1987}) ermöglicht sie skalierbare, reproduzierbare Analyse bei gleichzeitiger Transparenz.
...
\begin{itemize}
    \item \textbf{Gesamtindex der Abbildungen}: \url{https://victor-gurbani.github.io/JuFo2026/figures/}
    \item \textbf{Embeddings (PCA/t-SNE)}: \url{https://victor-gurbani.github.io/JuFo2026/figures/embeddings/}
    \item \textbf{Highlights (externe Stücke)}: \url{https://victor-gurbani.github.io/JuFo2026/figures/highlights/}
    \item \textbf{Signifikanz-Plots}: \url{https://victor-gurbani.github.io/JuFo2026/figures/significance/}
    \item \textbf{Harmonische Boxplots}: \url{https://victor-gurbani.github.io/JuFo2026/figures/harmonic/}
    \item \textbf{Melodische Boxplots}: \url{https://victor-gurbani.github.io/JuFo2026/figures/melodic/}
    \item \textbf{Rhythmische Boxplots}: \url{https://victor-gurbani.github.io/JuFo2026/figures/rhythmic/}
    \item \textbf{Annotierte MusicXML-Dateien}: \url{https://victor-gurbani.github.io/JuFo2026/figures/annotated/}
\end{itemize}

\subsection{Direktlinks zu interaktiven Kernansichten}
\begin{itemize}
    \item \textbf{PCA-Komponistenwolken (3D)}: \url{https://victor-gurbani.github.io/JuFo2026/figures/embeddings/composer_clouds_3d.html}
    \item \textbf{Highlight: One Summer's Day (Hisaishi)}: \url{https://victor-gurbani.github.io/JuFo2026/figures/highlights/one_summers_day_pca_cloud.html}
    \item \textbf{Highlight: Ravel String Quartet (F-Dur)}: \url{https://victor-gurbani.github.io/JuFo2026/figures/highlights/ravel_string_quartet_pca_cloud.html}
\end{itemize}
