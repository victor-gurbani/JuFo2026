...
\begin{figure}[htbp]
    ...
    \caption{Verwechslungsmatrix des Random-Forest-Modells (5-Fold Cross-Validation). Die Diagonale zeigt die korrekten Zuweisungen. Die meisten Fehler treten zwischen Chopin und Debussy auf, was die stilistische Nähe dieser Epochen im Merkmalsraum widerspiegelt.}\label{fig:rf_cm}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Precision-Recall-Scatterplot des Random Forests. Mozart und Debussy zeigen die höchste Trennschärfe, während Bach und Chopin aufgrund ihrer breiteren stilistischen Streuung komplexere Entscheidungsgrenzen erfordern.}\label{fig:rf_scatter}
\end{figure}
