...
Ein Random Forest trifft Vorhersagen durch einen Mehrheitsentscheid vieler individueller Bäume. Um die Nachvollziehbarkeit zu demonstrieren, wurde der mathematisch akkurateste Einzelbaum aus dem 100-Bäume-Ensemble (Baum \#71) extrahiert. Dieser Baum erreichte alleingestellt eine Genauigkeit von 72,4\,\% auf dem Testset.
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{SHAP-Werte für Johann Sebastian Bach. Niedrige Werte in \texttt{avg\_melodic\_interval} (blau, rechts) treiben die Vorhersage stark in Richtung Bach.}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/random_forest/rf_shap_summary_Debussy.png}
        \caption{SHAP-Werte für Claude Debussy. Hohe Werte in der strukturellen und rhythmischen Dichte treiben die Vorhersage zu Debussy.}
    \end{minipage}
\end{figure}
